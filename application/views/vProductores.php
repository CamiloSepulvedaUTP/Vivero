...
<p class="mb-4">
	Módulo de gestión de productores del sistema
</p>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<form class="modal-body" id="frmCrear" autocomplete="off">
				<p>Documento</p>
				<input type="text" class="form-control" data-db="ProductorId" required data-id autocomplete="off">
				<p>Nombres</p>
				<input type="text" class="form-control" data-db="Nombre" required autocomplete="off" maxlength="50">
				<p>Apellidos</p>
				<input type="text" class="form-control" data-db="Apellido" required autocomplete="off" maxlength="50">
			</form>
