...
<link href="assets/css/alertify.min.css" rel="stylesheet" id="bootstrap-css">
<link href="assets/css/themes/bootstrap.min.css" rel="stylesheet" id="bootstrap-css">
...
<body>
	<div class="login">
		...
		<form method="post" autocomplete="off">
			<input type="email" name="u" placeholder="Correo Electrónico" required="required" autofocus />
